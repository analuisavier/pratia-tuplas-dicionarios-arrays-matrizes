...
usuario['telefone_fixo'] = '3265-4321'
print(usuario)
...
produto_removido = produto.pop('id_produto', 'Produto não encontrado')
...
email_removido = usuario.pop('email', 'Email não encontrado.')
...
produtos = {'Fone de Ouvido': 249.99, 'Teclado Mecânico': 450.00, 'Mouse Gamer': 120.50}
...
print(f'Existe #importante: {existe_importante}')
...
print("Amigos de 101:", social_graph.obter_amigos(101))
print("Amigos de 205:", social_graph.obter_amigos(205))
print("Amigos de 999:", social_graph.obter_amigos(999))